...
celery_active_tasks = Gauge('celery_active_tasks', 'Number of active tasks', ['worker_name'])
celery_worker_count = Gauge('celery_worker_count', 'Number of active workers')
celery_task_duration = Histogram('celery_task_duration_seconds', 'Task execution duration', ['task_name'])

# Task Counters
celery_tasks_total = Counter('celery_tasks_total', 'Total number of tasks processed', ['task_name', 'status'])
celery_task_errors = Counter('celery_task_errors', 'Total number of task errors', ['task_name', 'error_type'])
